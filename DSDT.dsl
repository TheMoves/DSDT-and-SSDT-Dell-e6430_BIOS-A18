 ...
 *
 * Disassembly of DSDT.aml, Sat Jul  9 23:08:30 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000A56F (42351)
 *     Revision         0x02
 *     Checksum         0xE3
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000021)
{
    ...
    External (_SB_.PCI0.PEG0.VID_.MLTF, FieldUnitObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC9FFDE18, 0x01D3)
    ...
    OperationRegion (EXBU, SystemMemory, 0xC9FFFF18, 0x000E)
                    ...
                    Name (BUF0, ResourceTemplate()
{
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCB7C6E18, 0x10)
...
Store (0x07D0, OSYS)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (PS2K)
        {
            Name (_HID, "DLLK0534")  // _HID: Hardware ID
        ...
        Device (PS2M)
        {
            Name (_HID, EisaId ("DLL0534"))  // _HID: Hardware ID
